export interface HeaderProps {
    type: MenuElementsType;
    elements: MenuElementsModel[];
}

export enum MenuElementsType {
    menu = 'menu',
    social = 'social'
}
...
export const HeaderElements: HeaderProps[] = [
    {
        type: MenuElementsType.menu,
        elements: [
            {
        ...
        elements: [
            ...
            },
            {
                ...
                icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" fill="none">\n' +
                    '<path d="M15.2719 0.58659H18.0832L11.9415 7.60617L19.1667 17.1582H13.5094L9.0784 11.365L4.00833 17.1582H1.1954L7.76457 9.65L0.833374 0.58659H6.6343L10.6395 5.88187L15.2719 0.58659ZM14.2853 15.4756H15.843L5.78787 2.18087H4.11626L14.2853 15.4756Z" fill="black"/>\n' +
                    '</svg>',
                url: 'x'
            },
            {
                label: '',
                icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">\n' +
                    '<g clip-path="url(#clip0_91_10741)">\n' +
